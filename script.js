  ...
  .then(function (data) {
    ...
    const closingStock = async(orgId) => {
     ...
     const closingStock = async(orgId) => {
      ...
      document.getElementById("PartClosingStockH5").innerText = Math.round(partClosingStock.data.reduce((sum,cur) => sum + Number(cur.Closing_Stock), 0))
    ...
    const closingStock = async(orgId) => {
      ...
      document.getElementById("FGClosingStockH5").innerText = Math.round(fgClosingStock.data.reduce((sum,cur) => sum + Number(cur.Closing_Stock), 0))
